...
def fn(self, value):
    ...
    def test_encoder_template(self):
        ...
        self.assertEqual(result.creation[0], "self.encoder_ch1_no21_CC__p1 = EncoderElement(MIDI_CC_TYPE, 1, 21, Live.MidiMap.MapMode.relative_binary_offset)")
        self.assertEqual(result.creation[1], "self.encoder_ch1_no22_CC__p2 = EncoderElement(MIDI_CC_TYPE, 1, 22, Live.MidiMap.MapMode.relative_binary_offset)")
