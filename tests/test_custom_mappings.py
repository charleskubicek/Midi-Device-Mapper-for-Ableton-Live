...
class TestCustomMappings(unittest.TestCase):
    ...
    def test_find_user_defined_parameters_including_param_zero_for_on_off(self):
        ...
        self.assertEqual(actual_parameters[1].name, "p2")
        self.assertEqual(actual_parameters[2].name, "p5")
        self.assertEqual(actual_parameters[3].name, "p4")
    ...
    def test_filter_actual_parameters_with_custom_params_and_page_size(self):
        ...
        self.assertEqual(real_params[0].name, "p0")
        self.assertEqual(real_params[1].name, "p2")
        self.assertEqual(real_params[2].name, "p5")
        ...
        self.assertEqual(real_params[0].name, "p0")
        self.assertEqual(real_params[1].name, "p4")
